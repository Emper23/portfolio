...
- ไฟล์ `furina-bg.mp4` เป็นไฟล์สำรอง/ไม่ได้ถูกเรียกใช้ในหน้าเว็บปัจจุบัน หากไม่ใช้สามารถลบก่อน deploy ได้
...
- เสียง/วิดีโอเริ่มเล่นหลังผู้ใช้กดปุ่ม "click here" (ตามนโยบาย autoplay ของเบราว์เซอร์)
